...
<div class="rounded-xl backdrop-blur-md bg-white/10 border border-white/20 shadow-xl overflow-x-scroll sm:overflow-x-visible">
    <table class="w-full">
        <thead>
        ...
        <tbody class="text-indigo-800 text-center">
            ...
            <tr class="border-b odd:bg-white even:bg-gray-100 hover:bg-gray-100">
                <td class="py-4 px-6 font-bold text-xl text-indigo-600 ">{{ $class->department->name }}</td>
                <td class="py-4 px-6 font-medium text-lg">{{ $class->name }}</td>
                <td class="py-4 px-6  font-medium text-lg">{{ $class->section }}</td>
                <td class="py-4 px-6 font-medium text-lg">{{ $class->semester}}</td>
